  ...
  head: () => ({
    meta: [
      ...
      { title: "01 Transportes — Transporte escolar, locação e venda de veículos" },
      {
        name: "description",
        content:
          "01 Transportes: transporte escolar, locação e venda de veículos com frota revisada, documentação em dia e atendimento direto pelo WhatsApp.",
      },
      { property: "og:title", content: "01 Transportes — Transporte escolar e frota comercial" },
      {
        property: "og:description",
        content:
          "Frota escolar e comercial revisada, documentação em dia e atendimento direto pelo WhatsApp.",
      },
